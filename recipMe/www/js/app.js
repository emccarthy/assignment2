...
var app = {
  ...
  view: {},
  tabs: {
    home:    { index:i++, icon:'73-radar', },
    search:  { index:i++, icon:'86-camera', },
    favourites:   { index:i++, icon:'81-dashboard', },
    shoppinglist:  { index:i++, icon:'33-cabinet', },
    about: { index:i++, icon:'32-iphone', },
  },
...
bb.init = function() {
  ...
  bb.view.Search = Backbone.View.extend({
    initialize: function() {
      var self = this
      _.bindAll(self)
  ...
  bb.view.Favourites = Backbone.View.extend({
    initialize: function() {
      var self = this
      _.bindAll(self)
  ...
  bb.view.Shoppinglist = Backbone.View.extend({
    initialize: function() {
      var self = this
      _.bindAll(self)
  ...
  bb.view.About = Backbone.View.extend({
    initialize: function() {
      var self = this
      _.bindAll(self)
...
app.init = function() {
  ...
  app.view.search  = new bb.view.Search()
  app.view.favourites   = new bb.view.Favourites()
  app.view.shoppinglist  = new bb.view.Shoppinglist()
  app.view.about = new bb.view.About()
